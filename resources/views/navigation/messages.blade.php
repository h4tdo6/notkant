    ...
    <div class="flex h-screen">
        ...
        <div class="flex flex-col w-80 bg-black text-white border-r border-gray-800">
                    ...
                    <div class="flex flex-col items-center space-y-1 min-w-16">
                        <div class="relative">
                            <div class="rounded-full p-0.5">
                                <img src="{{ asset('assets/kant-profile.jpg') }}" alt="Your note"
                    ...
                    <div class="flex flex-col items-center space-y-1 min-w-16">
                        <div class="relative">
                            <div class="bg-gradient-to-r from-pink-500 to-orange-500 rounded-full p-0.5">
                                <img src="{{ asset('assets/aquinas-profile.jpg') }}" alt="profile"
                                    class="w-14 h-14 rounded-full border-2 border-black">
                            </div>
                        </div>
            ...
            <div class="flex border-b border-gray-800">
                <!-- Tabs content -->
                <button class="flex-1 py-3 {{ str_contains(url()->current(), '/messages/direct') ? 'font-semibold border-b-2 border-white' : 'text-gray-500' }}"
                    onclick="window.location.href='{{ route('direct.blank') }}'">
                    Messages
                </button>

                {{-- <button class="flex-1 py-3 {{ str_contains(url()->current(), '/messages/request') ? 'font-semibold border-b-2 border-white' : 'text-gray-500' }}"
                    onclick="window.location.href='{{ route('requests.blank') }}'">
                    Requests
                </button> --}}
            </div>
            ...
            <div class="flex-grow overflow-y-auto custom-scrollbar">
                ...
                <a href="{{ route('direct.aquinas') }}" class="block">
                    <div
                        ...
                        <div class="relative">
                            <img src="{{ asset('assets/aquinas-profile.jpg') }}" alt="Miracle"
                ...
                <a href="{{ route('direct.aristotle') }}" class="block">
                    ...
                    <div
                        ...
                        <div class="relative">
                            <img src="{{ asset('assets/aristotle-profile.jpg') }}" alt="ur_angie"
                                class="w-12 h-12 rounded-full">
                        </div>
                        <div class="ml-3 flex-grow">
                            <div class="flex justify-between items-center">
                ...
                {{-- <a href="{{ route('requests.plato') }}" class="block">
                    ...
                    <div class="flex items-center p-3 hover:bg-gray-500 cursor-pointer">
                        <div class="relative">
                            <img src="{{ asset('assets/plato-profile.jpg') }}" alt="Plato Profile"
                                class="w-12 h-12 rounded-full">
                        </div>
                        <div class="ml-3 flex-grow">
                            <div class="flex justify-between items-center">
                ...
                {{-- <a href="{{ route('requests.socrates') }}" class="block">
                    ...
                    <div class="flex items-center p-3 hover:bg-gray-500 cursor-pointer">
                        <div class="relative">
                            <img src="{{ asset('assets/socrates-profile.jpg') }}" alt="Socrates Profile"
                                class="w-12 h-12 rounded-full">
                        </div>
                        <div class="ml-3 flex-grow">
                            <div class="flex justify-between items-center">
